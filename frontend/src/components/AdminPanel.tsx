...
import { Card, Table, Button, Space, Typography, Tag, Modal, Form, Input, Select, message, Row, Col, Statistic } from 'antd';
import {
  UserOutlined,
  EditOutlined,
  DeleteOutlined,
...
import { userService, violationService, reservationService } from '../services/storage';
import { User, Violation, Reservation } from '../types';
      ...
      <Row gutter={[16, 16]} style={{ marginBottom: '24px' }}>
        ...
        <Col xs={24} sm={8}>
          <Card>
            <Statistic
              title="今日预约"
              value={reservations.filter(r => dayjs(r.createdAt).isSame(dayjs(), 'day')).length}
